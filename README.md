...
The code uses the Comple**X** **G**roup **I**nteractions (**XGI**) library in Python [https://xgi.readthedocs.io](https://xgi.readthedocs.io/). XGI repository: [https://github.com/xgi-org/xgi](https://github.com/xgi-org/xgi).   
